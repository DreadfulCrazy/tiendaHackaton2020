...
connection.query(query, function(err, rows, fields){
  if(err){
    ...
    return
  	...
  	var element = document.getElementById("userConnect");
	element.innerHTML = '<i class="fas fa-ellipsis-h"></i> <i class="fas fa-user"></i> '+row.username+' / Administrador'
  
  	var element = document.getElementById("userConnectB");
	element.innerHTML = '<i class="fas fa-ellipsis-h"></i> <i class="fas fa-user"></i> '+row.username+' / Administrador'

	var element = document.getElementById("userConnectM");
